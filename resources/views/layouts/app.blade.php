...
<body>
    ...
    <div class="w-full text-gray-700 bg-white dark-mode:text-gray-200 dark-mode:bg-gray-800" id="app">
        <div x-data="{ open: false }" class="flex flex-col max-w-screen-xl px-4 mx-auto md:items-center md:justify-between md:flex-row md:px-6 lg:px-8">
          <div class="p-4 flex flex-row items-center justify-between">
            <a href="{{ url('/') }}" class="text-lg font-semibold tracking-widest text-gray-900 uppercase rounded-lg dark-mode:text-white focus:outline-none focus:shadow-outline">
              <img src="{{ asset("images\home\Hololive_Production_logo.png") }}" alt="" class="h-16">
            </a>
            ...
            <footer class="bg-black dark:bg-gray-900">
              <div class="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
                  <div class="md:flex md:justify-between">
                    <div class="mb-6 md:mb-0">
                        <a href="https://flowbite.com/" class="flex items-center">
                            <img src="{{ asset("images\home\Hololive_Production_logo.png") }}" class="h-16 me-3" alt="FlowBite Logo" />
                ...
                <div class="sm:flex sm:items-center sm:justify-between">
                    <span class="text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2077 <a href="https://flowbite.com/" class="hover:underline">Weeraphat Boonsawai</a>. 6414421018
                    </span>
